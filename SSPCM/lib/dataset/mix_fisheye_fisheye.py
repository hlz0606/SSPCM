...
from dataset.fisheye import FisheyeDataset
...
class Mixed_Fisheye_Fisheye_Dataset(JointsDataset):

    def __init__(self, cfg, root, image_set, is_train, transform=None):
        transform_sup = transform
        self.coco = FisheyeDataset(cfg, root, image_set, is_train, transform_sup)
        ...
        if cfg.RAW_INPUT:
            self.ai = FisheyeDataset(cfg, root, image_set, False, transform)
        else:
            self.ai = FisheyeDataset(cfg, root, image_set, is_train, transform)
        ...
        if cfg.CONS_RAND_AUG:
            ...
            self.aug_ai = FisheyeDataset(cfg, root, image_set, is_train, transform_aug)
